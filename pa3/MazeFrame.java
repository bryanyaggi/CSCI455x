...
public class MazeFrame extends JFrame
{
   ...
   private JLabel searchStatusLabel; // displays initial prompt and the status of the search
   private MazeComponent mazeComponent; // displays the maze and path
   private Maze maze; // needed by component to access the data to display and by listener to initiate maze search.
